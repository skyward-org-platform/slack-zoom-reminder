...
def build_message(client_name: str, events: list[dict], tz: ZoneInfo) -> str:
    ...
    return (
        f"<!here> weekly {client_name} meeting is tomorrow at {time_str}, "
        f"please update all your client tasks today and drop a quick comment "
        f"on this message with any important updates from the past week."
    )
